...
class PaytmPayment implements PaymentInterface
{
    ...
    public function __construct()
    {
        ...
        $this->gateway = new \Braintree\Gateway([
                    'accessToken' => payment_gateway('access_token','Paytm')
                ]);
    ...
    public function ValidateTransactionId($transaction_id)
    {
        ...
        $environment = payment_gateway('mode','Paytm')=='sandbox' ? '.sandbox.':'.';
        ...
        curl_setopt($ch, CURLOPT_USERPWD, payment_gateway('client','Paytm').':'.payment_gateway('secret','Paytm'));
