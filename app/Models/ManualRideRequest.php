...
class ManualRideRequest extends Model
{
    /**
     ...
     */
    use SoftDeletes;
    protected $table = 'manual_ride_requests';

    protected $appends = ['driver_id','pickup_address','dropoff_address','pickup_lat','pickup_lng','dropoff_lat','dropoff_lng','status'];
