...
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 flexbox__item four-fifths page-content" style="padding:0px;" ng-controller="facebook_account_kit">
  ...
  <div class="" style="padding:0px 15px;">
   <form action="{{ url('driver_update_profile/'.$result->id) }}" id="form" class="layout layout--flush" enctype="multipart/form-data" name="driver_profile" method="POST">
    @csrf
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
      ...
      <div class="">
        <div class="autocomplete-input">
         <input type="text" name="address_line1" value="{{ @$result->driver_address->address_line1.@$result->driver_address->address_line2 }}" class="_style_3vhmZK" placeholder="{{ trans('messages.profile.addr') }}" id="home_address" autocomplete="false"> 
       </div>
...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="    padding: 5px 0px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 displayflex">
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
      <input type="text" name="city" value="{{ @$result->driver_address->city }}" class="_style_3vhmZK" placeholder="{{ trans('messages.profile.profile_city') }}" id="city">
...
<div class="parter-info separated--bottom col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 5px 0px;">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 displayflex">
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
      <input type="text" name="state" value="{{ @$result->driver_address->state }}" class="_style_3vhmZK" placeholder="{{ trans('messages.profile.state') }}" id="state">
    </div>
