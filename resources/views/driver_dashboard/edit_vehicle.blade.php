...
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 flexbox__item four-fifths page-content" style="padding:0px;" ng-controller="vehicle_details">
    ...
    <option value="" selected disabled>{{ trans('messages.driver_dashboard.select') }}</option>
    @foreach ($make as $key => $value)
        <option value="{{ $key }}" {{ $key == $result->vehicle_make_id ? 'selected' : '' }}>
            {{ $value }}
        </option>
    @endforeach
</select>
		...
		<div class="col-lg-12 form-group vehicle_model">
			 ...
			 <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
				<select name="vehicle_model_id" class="form-control" id="vehicle_model">
    <option value="" selected disabled>{{ trans('messages.driver_dashboard.select') }}</option>
    @foreach ($model as $key => $value)
        <option value="{{ $key }}" {{ $key == $result->vehicle_model_id ? 'selected' : '' }}>
            {{ $value }}
        </option>
    @endforeach
</select>
		...
		<div class="col-lg-12 form-group">
			 ...
			 <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
				<input type="text" name="vehicle_number" value="{{ $result->vehicle_number }}" class="form-control" id="vehicle_number" placeholder="{{ trans('messages.driver_dashboard.vehicle_number') }}">
		...
		<div class="col-lg-12 form-group">
			 ...
			 <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
				<input type="text" name="color" value="{{ $result->color }}" class="form-control" id="color" placeholder="{{ trans('messages.driver_dashboard.vehicle_color') }}">
		...
		<div class="col-lg-12 form-group">
			 ...
			 <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
				<input type="text" name="year" value="{{ $result->year }}" class="form-control" id="year" placeholder="{{ trans('messages.driver_dashboard.vehicle_year') }}" autocomplete="off">
		...
		<div class="col-lg-12 form-group">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
			<input type="radio" name="handicap" value="1" class="form-check-input" {{ in_array('2', $options) ? 'checked' : '' }}>
            {{ trans('messages.driver_dashboard.yes') }}

            <input type="radio" name="handicap" value="0" class="form-check-input" {{ !in_array('2', $options) ? 'checked' : '' }}>
		...
		<div class="col-lg-12 form-group">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
			<input type="radio" name="child_seat" value="1" class="form-check-input" {{ in_array('3', $options) ? 'checked' : '' }}>
               {{ trans('messages.driver_dashboard.yes') }}

               <input type="radio" name="child_seat" value="0" class="form-check-input" {{ !in_array('3', $options) ? 'checked' : '' }}>
            {{ trans('messages.driver_dashboard.no') }}
		...
		<div class="col-lg-12 form-group">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="padding:6px 0px;">
			<input type="radio" name="request_from" value="1" class="form-check-input" {{ in_array('1', $options) ? 'checked' : '' }}>
           {{ trans('messages.profile.female') }}

           <input type="radio" name="request_from" value="0" class="form-check-input" {{ !in_array('1', $options) ? 'checked' : '' }}>
