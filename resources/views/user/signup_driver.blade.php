...
<div class=" text--left signupdrive" ng-controller="facebook_account_kit">
  ...
  <div class="join-page" >
          ...
          <div class="container-fluid">
            <div class="col-lg-12 pad-0">
              ...
              <div class="col-lg-5 pad-0">
                  ...
                  <form action="{{ url('driver_register') }}" method="POST" class="layout layout--flush driver-signup-form-join-legacy" id="form">
                  @csrf
                ...
                <input type="hidden" name="otp" id="otp" value="">
                    ...
                    <div class="col-lg-12">
                      <div class="col-lg-6 p-0">
                        <div class="forminput">
                        <input type="text" class="_style_3vhmZK" placeholder="{{ trans('messages.user.firstname') }}" id="fname" name="first_name">
                          <span class="text-danger first_name_error">{{ $errors->first('first_name') }}</span>
                        </div>
                      </div>
                      <div class="col-lg-6 p-0">
                        <div class="forminput">
                          <input type="text" class="_style_3vhmZK" placeholder="{{ trans('messages.user.lastname') }}" id="lname" name="last_name">
                    ...
                    <div class="col-lg-12">
                      <div class="forminput">
                      <input type="text" name="email" class="_style_3vhmZK" placeholder="{{ trans('messages.user.email') }}">
                    ...
                    <div class="col-lg-12">
                      <div class="forminput">
                        ...
                        <div class="col-lg-9 p-0">
                          <input type="tel" name="mobile_number" value="{{ isset($phone_number) ? $phone_number : '' }}" class="_style_3vhmZK" placeholder="{{ trans('messages.profile.mobile') }}" id="mobile" style="margin-left: 2px;">
                    ...
                    <div class="col-lg-12">
                      <div class="forminput">
                        <input type="password" class="_style_3vhmZK" placeholder="{{ trans('messages.user.paswrd') }}" id="password" name="password">
                      ...
                      <div class="_style_3jmRTe" >
                        <div class="">
                          <div class="autocomplete-input">
                            <input type="text" name="home_address" class="_style_3vhmZK" placeholder="{{ trans('messages.profile.profile_city') }}" id="home_address" autocomplete="false" style="width:100%">
                          </div>
                  ...
                  <div class="col-lg-12">
                    <div class="forminput">
                     <input type="text" class="_style_3vhmZK text-uppercase" placeholder="{{ trans('messages.referrals.referral_code') }}" id="referral_code" name="referral_code">
    ...
    <div class="cls_arriving text--left"  style="background-color:#006161" >
