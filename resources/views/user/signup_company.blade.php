          ...
          <div class="container-fluid">
            <div class="col-lg-12 pad-0">
              ...
              <div class="col-lg-5 pad-0">
                  ...
                  <form action="{{ url('company_register') }}" method="POST" class="layout layout--flush driver-signup-form-join-legacy" id="form">
                  @csrf
                ...
                <input type="hidden" name="otp" id="otp" value="">
                 <!-- Your form content goes here -->
                    ...
                    <div class="col-lg-12">
                      <div class="forminput">
                       <input type="text" name="name" class="_style_3vhmZK" placeholder="{{ trans('messages.profile.name') }}" id="fname">
                    ...
                    <div class="col-lg-12">
                      <div class="forminput">
                      <input type="password" name="password" class="_style_3vhmZK" placeholder="{{ trans('messages.user.paswrd') }}" id="password">  
