		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<form method="POST" action="{{ url(LOGIN_USER_TYPE.'/add_vehicle') }}" class="form-horizontal" enctype="multipart/form-data" id="vehicle_form">
					...
					<div class="box-body">
						...
						@if (LOGIN_USER_TYPE!='company')
							<div class="form-group">
								...
								<select class="form-control" id="input_company_name" name="company_name" ng-model="company_name" ng-change="get_driver()">
                       ...
                       <option value="" disabled selected>Select</option>
			            ...
			            <div class="form-group">
			              ...
			              <div class="col-md-7 col-sm-offset-1">
							  ...
							  <select class="form-control" id="vehicle_model" name="vehicle_model_id">
                           <option value="" disabled selected>Select</option>
                          </select>
						...
						<div class="form-group">
							...
							<input type="radio" name="default" value="1" class="form-check-input default" id="default_yes" data-error-placement="container" data-error-container="#default_error">
                           <span style="margin-right: 15px;">Yes</span>

                            <input type="radio" name="default" value="0" class="form-check-input default" id="default_no" data-error-placement="container" data-error-container="#default_error">No
								</br>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1 form-check" style="padding-top: 6px;">
							<input type="radio" name="handicap" value="1" class="form-check-input handicap" id="handicap_yes" data-error-placement="container" data-error-container="#handicap_error">
                          <span style="margin-right: 15px;">Yes</span>

                          <input type="radio" name="handicap" value="0" class="form-check-input handicap" id="handicap_no" data-error-placement="container" data-error-container="#handicap_error">No
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1 form-check" style="padding-top: 6px;">
							<input type="radio" name="child_seat" value="1" class="form-check-input child_seat" id="child_seat_yes" data-error-placement="container" data-error-container="#child_seat_error">
                           <span style="margin-right: 15px;">Yes</span>

                           <input type="radio" name="child_seat" value="0" class="form-check-input child_seat" id="child_seat_no" data-error-placement="container" data-error-container="#child_seat_error">No
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1 form-check" style="padding-top: 6px;">
							<input type="radio" name="request_from" value="1" class="form-check-input request_from" id="request_from_female" data-error-placement="container" data-error-container="#request_from_error">
                         <span style="margin-right: 15px;">Female</span>

                         <input type="radio" name="request_from" value="0" class="form-check-input request_from" id="request_from_both" data-error-placement="container" data-error-container="#request_from_error"> Both
