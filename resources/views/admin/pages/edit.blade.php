              ...
              <span class="text-danger">(*)Fields are Mandatory</span>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    ...
                    <textarea name="content" id="content" hidden>{{ $result->content }}</textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <select name="footer" class="form-control" id="input_footer">
    <option value="" disabled>Select</option>
    <option value="yes" {{ $result->footer === 'yes' ? 'selected' : '' }}>Yes</option>
    <option value="no" {{ $result->footer === 'no' ? 'selected' : '' }}>No</option>
</select>
