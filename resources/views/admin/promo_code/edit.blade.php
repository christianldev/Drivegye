...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <form method="POST" action="{{ url('admin/edit_promo_code/'.$result->id) }}" class="form-horizontal">
    @csrf
              <div class="box-body">
              <span class="text-danger">(*)Fields are Mandatory</span>
               <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <input type="text" name="code" value="{{ $result->code }}" class="form-control" id="input_promo_code" placeholder="Promo Code">
    ...
    @foreach($currency as $code => $name)
        <option value="{{ $code }}" @if($code == $result->currency_code) selected @endif>{{ $name }}</option>
    @endforeach
</select>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                   <input type="text" name="expire_date" value="{{ $result->expire_date_mdy }}" class="form-control" id="input_expired_at" placeholder="Expire Date" autocomplete="off">
