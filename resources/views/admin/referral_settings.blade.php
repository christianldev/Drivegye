  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form action="{{ $update_url }}" method="POST" class="form-horizontal">
    @csrf
    @method('POST')
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-7 col-sm-offset-1">
              <select name="driver_currency" class="form-control" id="input_driver_currency">
    @foreach ($currency as $value => $label)
        <option value="{{ $value }}" {{ old('driver_currency', $driver_result['currency_code']) == $value ? 'selected' : '' }}>{{ $label }}</option>
    @endforeach
</select>
    ...
    @method('POST')
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-7 col-sm-offset-1">
              <select name="rider_currency" class="form-control" id="input_rider_currency">
    @foreach ($currency as $value => $label)
        <option value="{{ $value }}" {{ old('rider_currency', $rider_result['currency_code']) == $value ? 'selected' : '' }}>{{ $label }}</option>
    @endforeach
</select>
