		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<form action="{{ url('admin/edit_rider/'.$result->id) }}" method="POST" class="form-horizontal">
						@csrf
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<select class='form-control' id = 'input_country_code' name='country_code' >
									...
									@endforeach
									<input type="hidden" name="country_id" value="{{ $result->country_id }}" id="country_id">
								</select>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<input type="text" name="mobile_number" class="form-control" id="mobile_number" placeholder="Mobile Number" value="{{ old('mobile_number', $result->mobile_number) }}">
							...
							<div class="col-md-7 col-sm-offset-1">
								<div class="autocomplete-input-container">
									<div class="autocomplete-input">
										<input type="text" name="home_location" class="form-control" id="input_home_location" placeholder="Home Location" autocomplete="off" value="{{ @$location->home }}">
									</div>
						...
						<div class="form-group">
							...
							<div class="col-md-7 col-sm-offset-1">
								<div class="autocomplete-input-container">
									<div class="autocomplete-input">
										<input type="text" name="work_location" class="form-control" id="input_work_location" placeholder="Work Location" autocomplete="off" value="{{ @$location->work }}">
									</div>
