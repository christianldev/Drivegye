    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form action="{{ url('admin/edit_app_version/'.$result->id) }}" method="POST" class="form-horizontal form">
    @csrf
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <input type="text" name="version" value="{{ $result->version }}" class="form-control" id="input_name" placeholder="Version">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <select name="device_type" class="form-control" id="input_status">
    <option value="" disabled selected>Select</option>
    <option value="1" {{ $result->device_type == 1 ? 'selected' : '' }}>Apple</option>
    <option value="2" {{ $result->device_type == 2 ? 'selected' : '' }}>Android</option>
</select>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <select name="user_type" class="form-control" id="input_status">
    <option value="" disabled selected>Select</option>
    <option value="0" {{ $result->user_type == 0 ? 'selected' : '' }}>Rider</option>
    <option value="1" {{ $result->user_type == 1 ? 'selected' : '' }}>Driver</option>
</select>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <select name="force_update" class="form-control" id="input_status">
    <option value="" disabled selected>Select</option>
    <option value="1" {{ $result->force_update == 1 ? 'selected' : '' }}>Yes</option>
    <option value="0" {{ $result->force_update == 0 ? 'selected' : '' }}>No</option>
</select>
