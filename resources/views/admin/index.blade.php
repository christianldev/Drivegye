  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6">
        <!-- small box -->
        <a href="{{ url(LOGIN_USER_TYPE.'/trips') }}" class="small-box shadow">
          <div class="inner">
            <p>Total Earnings</p>
      ...
      <div class="col-lg-3 col-xs-6">
        <!-- small box -->
        <a href="{{ url(LOGIN_USER_TYPE.'/statements/overall') }}" class="small-box shadow">
          <div class="inner">
            <p> Received Amount </p>
      ...
      <div class="col-lg-3 col-xs-6">
        <!-- small box -->
        <a href="{{ url('admin/rider') }}" class="small-box shadow">
          <div class="inner">
            <p>Total Riders</p>
            <h3>{{ $total_rider }}</h3>
      ...
      <div class="col-lg-3 col-xs-6">
        <!-- small box -->
        <a href="{{ url(LOGIN_USER_TYPE.'/driver') }}" class="small-box shadow">
          <div class="inner">
            <p>Total Drivers</p>
            <h3>{{$total_driver}}</h3>
