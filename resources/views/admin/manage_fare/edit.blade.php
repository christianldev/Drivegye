    ...
    <div class="row" ng-cloak>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form action="{{ url('admin/edit_manage_fare/'.$result->id) }}" method="POST" class="form-horizontal" id="manage_peak_fare_form">
    @csrf
          <div class="box-body" ng-init="time_options={{ json_encode($time_options) }};day_options={{json_encode($day_options)}};">
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1" ng-init="location='{{ old('location','') }}'">
                <select name="location" class="form-control" id="input_location">
    <option value="" selected disabled>Select</option>
    @foreach($locations as $locationId => $locationName)
        <option value="{{ $locationId }}"{{ $locationId == $result->location_id ? ' selected' : '' }}>
            {{ $locationName }}
        </option>
    @endforeach
</select>
            ...
            <div class="form-group">
              ...
              <div class="col-md-7 col-sm-offset-1">
                <select name="vehicle_type" class="form-control" id="input_vehicle_type">
    <option value="" selected disabled>Select</option>
    @foreach($vehicle_types as $vehicleId => $vehicleName)
        <option value="{{ $vehicleId }}"{{ $vehicleId == old('vehicle_type', $result->vehicle_id) ? ' selected' : '' }}>
            {{ $vehicleName }}
        </option>
    @endforeach
</select>
            ...
            <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <input type="text" name="base_fare" value="{{ $result->base_fare }}" class="form-control" id="input_base_fare" placeholder="Base Fare">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <input type="text" name="capacity" value="{{ $result->capacity }}" class="form-control" id="input_capacity" placeholder="Capacity">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <input type="text" name="min_fare" value="{{ $result->min_fare }}" class="form-control" id="input_min_fare" placeholder="Minimum Fare">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <input type="text" name="per_min" value="{{ $result->per_min }}" class="form-control" id="input_per_min" placeholder="Per Minutes">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <input type="text" name="per_km" value="{{ $result->per_km }}" class="form-control" id="input_per_km" placeholder="Per Kilometer">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <input type="text" name="waiting_time" value="{{ old('waiting_time', $result->waiting_time) }}" class="form-control" id="input_waiting_time" placeholder="Waiting Time">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <input type="text" name="waiting_charge" value="{{ old('waiting_charge', $result->waiting_charge) }}" class="form-control" id="input_waiting_charge" placeholder="Waiting Charge">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-7 col-sm-offset-1">
                    <input type="text" name="schedule_fare" value="{{ $result->schedule_fare }}" class="form-control" id="input_schedule_fare" placeholder="Schedule Ride Fare">
