    ...
    <div class="container h-100">
        <div class="row d-flex align-items-center h-100">
            <div class="col-md-12 text-center">
                <h2 class="h1 font-weight-bold">{{trans('messages.rider.title')}}</h2>
                <nav class="mt-15" aria-label="breadcrumb">
                    <ol class="breadcrumb font-weight-bold bg-transparent p-0 justify-content-center">
                        ...
                        <li class="breadcrumb-item text-primary" aria-current="page">{{trans('messages.rider.title')}}</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-around">
            <div class="col-lg-7" data-aos="fade-up" data-aos-delay="150">
                <img class="img-fluid rounded-lg shadow" src="theme/images/screenshots/user6.png" alt="">
            </div>
            <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-in">
                <h2 class="section-title"><strong>{{trans('messages.rider.subtitle')}}</strong></h2>
                <p>{{trans('messages.rider.subtitle_description')}}</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4 col-md-5" data-aos="fade-in">
                <h2 class="section-title"> <strong>{{trans('messages.rider.subtitle2')}}</strong></h2>
                <p>{{trans('messages.rider.subtitle2_description')}}</p>
            </div>
...
<section class="pt-50 pb-50">
    <div class="container">
        <div class="row align-items-center justify-content-around">
            ...
            <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-in">
                <h2 class="section-title">{{$site_name}} <strong>{{trans('messages.rider.subtitle3')}}</strong></h2>
                <p class="mb-30">{{trans('messages.rider.subtitle3_description')}}</p>
            </div>
        </div>
    </div>
</section>
