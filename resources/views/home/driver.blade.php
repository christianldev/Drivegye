    ...
    <div class="container h-100">
        <div class="row d-flex align-items-center h-100">
            <div class="col-md-12 text-center">
                <h2 class="h1 font-weight-bold">{{trans('messages.driver.title')}}</h2>
                <nav class="mt-15" aria-label="breadcrumb">
                    <ol class="breadcrumb font-weight-bold bg-transparent p-0 justify-content-center">
                        ...
                        <li class="breadcrumb-item text-primary" aria-current="page">{{trans('messages.driver.title')}}</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-around">
            <div class="col-lg-7" data-aos="fade-up" data-aos-delay="150">
                <img class="img-fluid rounded-lg shadow" src="theme/images/screenshots/newtaxi prime driver.png" alt="">
            </div>
            <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-in">
                <h2 class="section-title"><strong>{{trans('messages.driver.subtitle')}}</strong></h2>
                <p>{{trans('messages.driver.subtitle_description')}}</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4 col-md-5" data-aos="fade-in">
                <h2 class="section-title"><strong>{{trans('messages.driver.subtitle2')}}</strong></h2>
                <p>{{trans('messages.driver.subtitle2_description')}}</p>
            </div>
            <div class="col-lg-8 col-md-7" data-aos="fade-up" data-aos-delay="150">
                <div class="has-shapes">
                    <img class="img-fluid py-4 my-2" src="theme/images/screenshots/newtaxi prime driver create ride.png" alt="">
    ...
    <div class="container">
        <div class="row align-items-center justify-content-around">
            <div class="col-lg-7" data-aos="fade-up">
                <img class="img-fluid" src="theme/images/screenshots/user7.png" alt="">
            </div>
            <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-in">
                <h2 class="section-title">{{$site_name}} <strong>{{trans('messages.driver.subtitle3')}}</strong></h2>
                <p class="mb-30">{{trans('messages.driver.subtitle3_description')}}</p>
            </div>
        </div>
    </div>
</section>
