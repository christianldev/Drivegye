...
<div class="content-wrapper" ng-controller="payout_preferences">
    ...
    <!-- Your form fields and content here -->
        ...
        id="payout_info_payout_country" 
        ng-model="country" 
        ng-change="countryChanged()">
    <option value="" disabled selected>Select</option>
    @foreach ($country as $key => $value)
        <option value="{{ $key }}"{{ $key == old('country', $default_country) ? ' selected' : '' }}>
            {{ $value }}
        </option>
    @endforeach
</select>
				...
				<div class="payout_popup_view">
					...
					<div class="payout_input_field">
						<input type="text" 
       name="address1" 
       id="payout_info_payout_address1" 
       ng-model="address1">
					</div>
				...
				<div class="payout_popup_view">
					...
					<div class="payout_input_field">
						<input type="text" 
       name="address2" 
       id="payout_info_payout_address2" 
       ng-model="address2">
					</div>
       ...
       value="{{ old('state') }}">
				...
				<div class="payout_popup_view">
					...
					<div class="payout_input_field">
						<input type="text" 
       name="postal_code" 
       id="payout_info_payout_zip" 
       ng-model="postal_code">
	...
	<div class="modal poppayout" id="payout_popup-paypal" aria-hidden="false" tabindex="-1">
		<div id="modal-add-payout-set-address" class="modal-content">
			...
			<form action="{{ route('company.update_preference') }}" 
      method="POST" 
      class="modal-add-payout-pref" 
      id="payout_paypal">
    @csrf
    ...
    <!-- Your form content goes here -->
        ...
        ng-model="payout_country" 
        ng-change="changeCurrency()">
    <option value="" disabled selected>Select</option>
    @foreach ($country_list as $countryKey => $countryValue)
        <option value="{{ $countryKey }}"{{ $countryKey == $default_country ? ' selected' : '' }}>
            {{ $countryValue }}
        </option>
    @endforeach
</select>
    ...
    <option value="" disabled selected>{{ trans('messages.profile.gender') }}</option>
    <option value="male">{{ trans('messages.profile.male') }}</option>
    <option value="female">{{ trans('messages.profile.female') }}</option>
</select>dth:140px;']) !!}
