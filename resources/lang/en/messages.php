...
return [
	...
	'home' => [
		...
		'anywhere_content' => 'Daily commute. Errand across town. Early morning travel. Late night drinks. Wherever you’re headed, count on Eycab for a ride—no reservations required.',
		...
		'home_title' =>'Making Taxi Companies Better',
		'home_title_content' =>'Drive automation, efficiency, growth and profitability in your company with NewTaxi Prime’s complete taxi platform.Be our next customer success story.',
		'home_title2' =>'Own your local market by using world-class technology',
		'home_title2_content'=>'NewTaxi Prime’s fully-integrated taxi dispatch platform gives you all the tools you need to successfully operate your taxi company in today’s competitive transport landscape. Delight your passengers with market-leading booking solutions, intelligently match supply and demand with our highly-customisable dispatch engine, and attract and retain drivers with an app designed to optimise their earnings.',
		'rider_app'=>'Rider App',
		'driver_app'=>'Driver App',
		'company_dashboard'=>'Company Dashboard',
		'administrator_dashboard'=>'Administrator Dashboard',
		'booking_app'=>'Booking App',
		'booking_app_content'=>'Delight your passengers with a white-lable app to rival any of the global players. Newtaxi Prime ’s passenger app delivers the ultimate in user experience, with a clean and simple design, intuitive and engaging booking flows, and fast, secure payment options. Generate more app trips and driver earnings and reduce Customer no shows and cancellations.',
		'drive_with_newtaxi_prime'=>'Drive With NewTaxi Prime',
		'drive_with_newtaxi_prime_content'=>'Attract and Retain drivers with a stylish new iOS & Android App designed to help them maximise and manage their earnings. The NewTaxi Prime Driver App is continuously upgraded to introduce new features and enhancements that help your drivers work better. Make their job as simple and safe as possible, and optimise their trips so that they make more money, in less time!',
		'manage'=>'Manage',
		'manage_content'=>'Streamline all your back-end administration processes to gain operational efficiencies for your taxi company. Here you can store and manage all of your passenger, driver, vehicle and business records, configure pricing including fixed fares and tariffs, and set up your zone profiles. Highly configurable, reliable with updates in real time.',
		'admin_dash'=>'Core Management',
		'admin_dash_content'=>'NewTaxi Prime is built in a way that you can manage drivers as a super administrator as well as manage company drivers. The platform workflow is a multivendor based which allow other companies to register and manage their drivers which in turns is managed by the super administrator.',
	],
	...
	'header' =>[
		...
		'signinrider' => 'Sign In Rider',
		'signindriver' => 'Sign In Driver',
		'signincompany' => 'Sign In Company',
	...
	'drive' =>[
		...
		'fare_start' => 'At Eycab, our trip fares start with a base amount, then increase with time and distance. And when demand is higher than normal, drivers earn more income.',
		...
		'sign_online' => 'Sign up on Eycab online',
	...
	'user' => [
		...
		'no_office_content' => 'Whether you’re supporting your family or saving for something,',
		'freedom' => 'gives you the freedom to get behind the wheel when you want. Choose when to drive, where you go, and who to drive.',
	...
	'about_us' => [
        ...
        'our_team' 		=> 'Our Team',
        'title' 		=> 'We reimagine the way the world moves for the better',
        'subtitle1'     =>'Movement is what we power. It’s our lifeblood. It runs through our veins. It’s what gets us out of bed each morning. It pushes us to constantly reimagine how we can move better. For you. For all the places you want to go. For all the things you want to get. For all the ways you want to earn. Across the entire world. In real time. At the incredible speed of now.',
        'card_title1'   =>'Launched In April Of',
        'card_title2'   =>'Our product powers',
        'card_title3'   =>'Served customers',
        'card_title4'   =>'Made by hand in',
        'card_subtitle1'  =>'2023',
        'card_subtitle2'   =>'1000',
        'card_subtitle3'   =>'50',
        'card_subtitle4'   =>'120',
        'title2' 		=> 'What makes NewTaxi Sustainable?',
        'subtitle2'    =>'NewTaxi is committing to becoming a fully electric, zero-emission platform by 2040, with 100% of rides taking place in zero-emission vehicles, on public transit, or with micromobility. It is our responsibility as the largest mobility platform in the world to more aggressively tackle the challenge of climate change. We will do this by offering riders more ways to ride green, helping drivers go electric, making transparency a priority and partnering with NGOs and the private sector to help expedite a clean and just energy transition.',
        'ratetitle' 	=> 'Average Yearly Growth Rate Across Our Clients We Able To Achive',
        'ratesubtitle' 	=> 'In addition to helping riders find a way to go from point A to point B,  helping people order food quickly  affordably, removing barriers to healthcare, creating new freight-booking solutions, helping companies provide a seamless employee travel experience. And always helping drivers and couriers earn.',
        'years' 		=> '10',
        'years_title' 	=> 'Years Of Experience',
        'users' 		=> '13',
        'users_title' 	=> 'More Real Active users',
        'employees' 	=> '3000',
        'employees_title' => 'Employees Work Here',
        'secure' 		=> 'Fully Secure And Hacking Free',
        'support' 		=> 'Always Having A Great Supports',
        'time_balancing'=> 'Build with Time Balanceing',
        'safe_condition'=> 'Fully Prepared with Safe Condition',
        'ceo_statement'  =>'Today, NewTaxi accounts for less than 1% of all miles driven globally. Just a small percentage of people in countries where NewTaxi is available have ever used our services. And we are still barely scratching the surface when it comes to huge industries like food and logistics, and how the future of urban mobility will reshape cities for the better.',
	],
	'services' =>[
	    'title'   =>'NewTaxi’s technology offerings',
	    'subtitle' =>'NewTaxi apps, products, and other offerings',
	    'subtitle_description' =>'NewTaxi is a technology company whose mission is to reimagine the way the world moves for the better. Our technology helps us develop and maintain multisided platforms that match consumers looking for rides and independent providers of ride services, as well as with other forms of transportation, including public transit, bikes, and scooters.'
	],
	
	'how_it_works' =>[
	    'title'   =>'How to use the NewTaxi app',
	    'subtitle1' =>'A rider opens the app',
	    'subtitle1_description' =>'The rider enters their destination into the “Where to?” box; reviews each ride option for vehicle size, price, and estimated dropoff time; chooses the desired option; then confirms the pickup.',
	    'subtitle2' =>'The rider is matched with a driver',
	    'subtitle2_description'=>'A nearby driver sees and chooses to accept the rider’s ride request. The rider is automatically notified when the driver’s vehicle is about a minute away.',
	    'subtitle3' =>'The driver picks up the rider',
	    'subtitle3_description'=>'The driver and the rider verify each other’s names and the destination. Then the driver starts the ride.',
	    'subtitle4' =>'The driver takes the rider to the destination',
	    'subtitle4_description'=>'The app gives the driver the option to access turn-by-turn directions.',
	    'subtitle5' =>'The driver and rider leave ratings and reviews',
	    'subtitle5_description'=>'At the end of each trip, drivers and riders can rate each other from 1 to 5 stars. Riders also have the option to give the driver compliments and a tip directly in the app.',
	    
	],
	'rider' =>[
	    'title'   =>'Rider App',
	    'subtitle' =>'Give your customers a world-class Passenger Experience',
	    'subtitle_description' =>'Did you know that App users take 2.2 times as many trips over a year than customers who phone in? Getting your customers onto your passenger app makes them sticky, helping to generate more trips and more money for your drivers. A great digital experience, matched with your superior service delivers on that all important customer loyalty.',
	    'subtitle2' =>'Reserve a ride that\'s ready when you are',
	    'subtitle2_description' =>'Now more than ever, reservations are a way of life. Reserve a premium Uber experience, up to 90 days in advance, for whenever you’re ready to ride.',
	    'subtitle3' =>'Wallet',
	    'subtitle3_description' =>'Wallet is the new home for your money on NewTaxi Prime. Easily track your earning and spending history, manage and move your money, and discover new financial products all in one place.',
	     
	],
	
	'driver' =>[
	    'title'   =>'Driver App',
	    'subtitle' =>'Delight your drivers with the brand new Newtaxi Prime Driver App',
	    'subtitle_description' =>'Driver recruitment and retention are high on the agenda of every taxi company right now. You’re not alone! One sure-fire way to make your taxi company attractive to work for is to give your drivers stylish, user-friendly and reliable technology that helps make their job as easy as possible. That’s exactly what your drivers get with the brand-new NewTaxi Prime Driver App. The fresh new look and feel, and enhanced feature set is all about helping your drivers to work smarter – so they can make more money in less time. Pair this world-class app with NewTaxi Prime’s unrivaled reliability and driver-earning incentives like surge pricing and no-show fees, and you’ll fast become the most attractive taxi fleet in town.',
	    'subtitle2' =>'Create Ride',
	    'subtitle2_description' =>'Let your drivers initiate an intant pick-up along the road for customers without Rider Apps.',
	    'subtitle3' =>'Driver Wallet',
	    'subtitle3_description' =>'Wallet is the new home for your money on NewTaxi Prime. Easily track your earning and spending history, manage and move your money, and discover new financial products all in one place.',
	],
	
	'money' =>[
	    'title'   =>'Wallet',
	    'subtitle' =>'Payments tailored to the taxi industry',
	    'subtitle_description' =>'NewTaxi Prime platform facilitates complex payment solutions across all our products, built specifically for the unique use cases of fleets in the mobility industry. Our payment console makes it so easy for you and your team to manage, action, report and reconcile your payments. With the payment console, your workload is minimal! ',
	    'subtitle2' =>'Wallet To Wallet Transfer',
	    'subtitle2_description' =>'With NewTaxi Prime\'s Wallet, drivers and customers can do transaction via one wallet to the other safe and securely.',
	    'subtitle3' =>'NewTaxi Prime Payment Gateways',
	    'subtitle3_description' =>'Newtaxi Prime comes in handy with more than six payment gataway covering atleast 95% worldwide transaction services.These payment gateways inlcude; Stripe, Paypal, Flutterwave, Braintree, Paystack, Mollie, Mpesa, Razorpay, PayTm, Cash',
	],
	
	'company' =>[
	    'title'   =>'Company Dashboard',
	    'subtitle' =>'Control the key areas of your business in one place',
	    'subtitle_description' =>'‘Manage’ handles all your back-end processes. It stores and streamlines all of your driver, vehicle, passenger and corporate business records, and automates invoicing, billing and reporting. It’s here where you can configure the system to meet all of your unique needs – giving you the flexibility and control to dispatch your way – from managing all your pricing including fixed fares and tariffs to setting and changing your driver zones.',
	    'subtitle2' =>'Dynamic Dispatch, Zone & Site management',
	    'subtitle2_description' =>'NewTaxi Prime Ride Dispatch system allows you to manage all your drivers with manual booking and ride scheduling features that are best for your taxi business.',
	    'subtitle3' =>'Live Tracking System',
	    'subtitle3_description' =>'Newtaxi Prime Live Tracking feature helps you track your driver current locations.',
	],
];
